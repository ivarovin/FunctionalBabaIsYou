...
public static class Grammar
{
    ...
    public static string DefinitionOf(this IEnumerable<((int x, int y) whereIs, string block)> blocks, string subject)
    {
        ...
        return blocks.ContainsDefinitionFor(subject)
            ? blocks.First(block => block.IsToTheRightOf(blocks.WhereIsLinkingVerbForSubject(subject))).block
            : string.Empty;
    }
    ...
    static (int x, int y) WhereIsLinkingVerbForDefinition(this IEnumerable<((int x, int y) whereIs, string block)> blocks,
        string what)
    ...
    static bool ExistsLinkingVerbForDefinition(this IEnumerable<((int x, int y), string what)> blocks, string definition)
